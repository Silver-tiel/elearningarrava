                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-xs font-semibold text-emerald-600 bg-emerald-50 px-2 py-1 rounded-md">+12%</span>
                        </div>
                        <div class="mt-4">
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-xs font-semibold text-emerald-600 bg-emerald-50 px-2 py-1 rounded-md">+8%</span>
                        </div>
                        <div class="mt-4">
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-xs font-semibold text-emerald-600 bg-emerald-50 px-2 py-1 rounded-md">+15%</span>
                        </div>
                        <div class="mt-4">
                    ...
                    <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-xs font-semibold text-emerald-600 bg-emerald-50 px-2 py-1 rounded-md">+4%</span>
                        </div>
                        <div class="mt-4">
                    ...
                    <div class="lg:col-span-2 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between">
                        ...
                        <div class="relative w-full h-48 my-2 flex flex-col justify-end">
                            <svg class="w-full h-full overflow-visible" viewBox="0 0 500 150" preserveAspectRatio="none">
                                ...
                                <path d="M0,110 L70,95 L140,115 L210,80 L280,95 L350,50 L420,60 L490,40 L490,150 L0,150 Z" fill="url(#chartGradient)" />
                                <path d="M0,110 L70,95 L140,115 L210,80 L280,95 L350,50 L420,60 L490,40" fill="none" stroke="#3B82F6" stroke-width="3" />
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <img class="w-10 h-10 rounded-full object-cover" src="https://i.pravatar.cc/100?img=11" alt="Ahmad Rayhan">
                                    <div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <img class="w-10 h-10 rounded-full object-cover" src="https://i.pravatar.cc/100?img=5" alt="Siti Nurhaliza">
                                    <div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <img class="w-10 h-10 rounded-full object-cover" src="https://i.pravatar.cc/100?img=12" alt="Rudi Santoso">
                                    <div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <img class="w-10 h-10 rounded-full object-cover" src="https://i.pravatar.cc/100?img=9" alt="Dewi Lestari">
                                    <div>
                    ...
                    <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 class="text-xs font-bold text-gray-900 leading-tight">Bahasa Inggris Conversation</h4>
