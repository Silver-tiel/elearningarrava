...
<body class="min-h-screen bg-white font-sans text-[#172036] antialiased">
    <main class="min-h-screen p-0 sm:p-4 lg:p-6">
        <div class="mx-auto grid min-h-screen w-full max-w-[1200px] overflow-hidden rounded-none bg-white shadow-[0_24px_55px_rgba(33,70,115,0.10)] sm:min-h-[700px] sm:rounded-[24px] lg:grid-cols-2">
            {{-- Form panel --}}
            ...
            {{-- Illustration panel --}}
            <aside class="hidden items-center justify-center bg-gradient-to-br from-[#EDF5FF] via-[#E8F2FF] to-[#DFEEFF] px-10 py-12 text-center lg:flex lg:px-[54px]">
