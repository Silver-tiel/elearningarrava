            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <button type="button" data-toggle-password="password"
                        class="absolute right-2.5 top-1/2 -translate-y-1/2 p-1.5 text-[#92A3BB]"
...
@section('illustration')
    <img src="{{ asset('images/auth/login-illustration.png') }}" alt="Siswa sedang belajar"
        class="mx-auto mb-[31px] block h-[280px] w-full max-w-[380px] rounded-[22px] object-cover">
